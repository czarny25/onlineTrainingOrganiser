...
//
//function createForm(ListOfExercesesNames) {
//	tableNu++;
//	presentExercise(tableNu, ListOfExercesesNames);
//	alert("exe sending");
//}
...
function presentExercise(tableNum, exercise) {
	...
	/////// ------------ here is created one exercise header ----      /////////
	
	var myTable = document.createElement("table");
	myTable.setAttribute("id", tableID);
	myTable.setAttribute("class", "exeTable");
	
	var exerciseNameRow = document.createElement("tr");
	exerciseNameRow.setAttribute("class", "row");
	...
	exerciseId.setAttribute("class", "col-sm-1");
	...
	exerciseName.setAttribute("class", "col-sm-6");
	...
	exerciseCancelButton.setAttribute("class", "col-sm-1");
	...
	addExerciseButton.setAttribute("class", "col-sm-4");
...
function createSetsRow(myTable, tableNum, set) {
	...
	nodeWeight.setAttribute("class", "col-sm-3");
	...
	nodeButton.setAttribute("class", "col-sm-1");
	var button = document.createElement("input");
	button.setAttribute("type", "button");
	...
	nodeButton.setAttribute("class", "col-sm-4");
	var button2 = document.createElement("input");
	button2.setAttribute("type", "button");
